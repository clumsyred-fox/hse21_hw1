...
## Результат для 2 млн paired-end ридов и 500 тыс. mate-pairs ридов
...
###### Казалось бы, после настолько сильного обрезания размера данных результат должен быть ужасным, однако ухудшение хоть и есть, оно не очень сильное. Стало больше коротких контигов/скаффолдов и больше гэпов, однако N50 и длина самого большого скаффолда изменились слабо.
